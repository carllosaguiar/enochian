 ...
 */
final class Version20210411012951 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cabala ADD CONSTRAINT FK_B0376950A76ED395 FOREIGN KEY (user_id) REFERENCES profile (id)');
