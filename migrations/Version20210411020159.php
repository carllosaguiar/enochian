 ...
 */
final class Version20210411020159 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cabala ADD CONSTRAINT FK_B0376950A76ED395 FOREIGN KEY (user_id) REFERENCES profile (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
